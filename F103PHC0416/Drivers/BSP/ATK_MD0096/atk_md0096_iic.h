...
#define ATK_MD0096_IIC_SCL_GPIO_PORT            GPIOA
#define ATK_MD0096_IIC_SCL_GPIO_PIN             GPIO_PIN_15
#define ATK_MD0096_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE();  \
                                                        __HAL_RCC_AFIO_CLK_ENABLE();    \
                                                    __HAL_AFIO_REMAP_SWJ_NOJTAG();  \
                                                        }while(0)

#define ATK_MD0096_IIC_SDAIN_GPIO_PORT          GPIOB
#define ATK_MD0096_IIC_SDAIN_GPIO_PIN           GPIO_PIN_13
