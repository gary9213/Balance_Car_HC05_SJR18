...
/* 引脚定义 */
#define ATK_MS6050_AD0_GPIO_PORT            GPIOB
#define ATK_MS6050_AD0_GPIO_PIN             GPIO_PIN_9
/* PA15需禁用JTAG才能做普通IO */
#define ATK_MS6050_AD0_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE();   \
                                            }while(0)


#define ATK_MS6050_VCC_GPIO_PORT            GPIOB
#define ATK_MS6050_VCC_GPIO_PIN             GPIO_PIN_5
#define ATK_MS6050_VCC_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOB_CLK_ENABLE();   \
                                                  }while(0)   /* PA口时钟使能 */
#define ATK_MS6050_GND_GPIO_PORT            GPIOB
#define ATK_MS6050_GND_GPIO_PIN             GPIO_PIN_6
#define ATK_MS6050_GND_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOB_CLK_ENABLE();   \
                                                  }while(0)   /* PA口时钟使能 */
...
#define ATK_MS6050_VCC(x)                   do{ x ?                                                                                     \
                                                HAL_GPIO_WritePin(ATK_MS6050_VCC_GPIO_PORT, ATK_MS6050_VCC_GPIO_PIN, GPIO_PIN_SET) :    \
                                                HAL_GPIO_WritePin(ATK_MS6050_VCC_GPIO_PORT, ATK_MS6050_VCC_GPIO_PIN, GPIO_PIN_RESET);   \
                                            }while(0)
#define ATK_MS6050_GND(x)                   do{ x ?                                                                                     \
                                                HAL_GPIO_WritePin(ATK_MS6050_GND_GPIO_PORT, ATK_MS6050_VCC_GPIO_PIN, GPIO_PIN_SET) :    \
                                                HAL_GPIO_WritePin(ATK_MS6050_GND_GPIO_PORT, ATK_MS6050_GND_GPIO_PIN, GPIO_PIN_RESET);   \
                                            }while(0)
