...
#define ATK_MS6050_IIC_SCL_GPIO_PIN             GPIO_PIN_7
#define ATK_MS6050_IIC_SCL_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOB_CLK_ENABLE();   \
                                                   }while(0)   /* PA口时钟使能 */

#define ATK_MS6050_IIC_SDA_GPIO_PORT            GPIOB
#define ATK_MS6050_IIC_SDA_GPIO_PIN             GPIO_PIN_8
#define ATK_MS6050_IIC_SDA_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOB_CLK_ENABLE();   \
                                                  }while(0)   /* PA口时钟使能 */
