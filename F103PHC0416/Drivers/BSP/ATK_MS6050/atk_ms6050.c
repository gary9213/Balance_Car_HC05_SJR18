...
static void atk_ms6050_hw_init(void)
{
    ...
    HAL_GPIO_Init(ATK_MS6050_AD0_GPIO_PORT, &gpio_init_struct);
        ...
        gpio_init_struct.Pin    = ATK_MS6050_VCC_GPIO_PIN;  /* AD0引脚 */
    gpio_init_struct.Mode   = GPIO_MODE_OUTPUT_PP;      /* 推挽输出 */
    gpio_init_struct.Pull   = GPIO_PULLUP;              /* 上拉 */
    gpio_init_struct.Speed  = GPIO_SPEED_FREQ_HIGH;     /* 高速 */
    HAL_GPIO_Init(ATK_MS6050_VCC_GPIO_PORT, &gpio_init_struct);
    ATK_MS6050_VCC(1);

        gpio_init_struct.Pin    = ATK_MS6050_GND_GPIO_PIN;  /* AD0引脚 */
    gpio_init_struct.Mode   = GPIO_MODE_OUTPUT_PP;      /* 推挽输出 */
    gpio_init_struct.Pull   = GPIO_PULLUP;              /* 上拉 */
    gpio_init_struct.Speed  = GPIO_SPEED_FREQ_HIGH;     /* 高速 */
    HAL_GPIO_Init(ATK_MS6050_GND_GPIO_PORT, &gpio_init_struct);
     ATK_MS6050_GND(0);
...
uint8_t atk_ms6050_init(void)
{
    ...
    atk_ms6050_set_rate(100);                                                /* 采样率，100Hz */
    atk_ms6050_write_byte(ATK_MS6050_IIC_ADDR, MPU_INT_EN_REG, 0X00);       /* 关中断 */
